...
import com.samsung.appsamples.photos.adapter.ServiceAdapter;
...
public class ConnectivityManager {
    ...
    public ConnectivityManager() {
        ...
        adapter = new ServiceAdapter(App.getInstance(), R.layout.cell_service_layout);
    ...
    public void stopDiscovery() {
        Log.d(Constants.APP_TAG, "stopDiscovery");
                ...
                if (mMultiscreenApp != null && mMultiscreenApp.isConnected()) {
                    mMultiscreenApp.disconnect(new Result<Client>() {
                        ...
                        public void onError(com.samsung.multiscreen.Error error) {
                            //disconnect failed.
                            Log.e(Constants.APP_TAG, "disconnect onError: " + error.getMessage());
    ...
    public void launchApplication() {
        ...
        mMultiscreenApp = service.createApplication(url, Constants.CHANNEL_ID);
